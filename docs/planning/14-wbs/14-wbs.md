  ...
  - name: "Sprint 1"
    ...
    issues:
      - slug: "setup/workspace-scaffold"
        title: "setup: pnpm workspace + Vite + Express + Prisma + 3 profile env"
  ...
  - name: "Sprint 3"
    ...
    issues:
      ...
      - slug: "frontend/favorite-button"
        title: "feat(fe): ♥ 버튼 + 낙관적 업데이트 + Profile favorites 탭"
        labels: ["type:feature", "area:frontend", "priority:P0"]
        effort: "2d"
        r_ids: ["R-F-14"]
        f_ids: ["F-07"]
      ...
      - slug: "test/compliance-perf-sec"
        title: "test: Newman 100% + autocannon P95 + /cso high 0"
